...
try:
    ...
    def extract_preview_parameters(ss):
        return None

    def get_preview_resolution(*args):
        return (84, 42, 168, 84)

    def setup_preview_style(*args):
        return None
    ...
    def should_update_preview_ui(*args):
        return (True, None)

    def compute_preview_signatures(*args):
        return (None, None)

    def generate_preview_arrays(*args):
        return (None, None, None, 0.0)

    def build_preview_mesh(*args):
        return (None, False)

    def render_quick_preview_surface(*args):
        pass

    def render_full_preview_mesh(*args):
        pass

    def render_preview_png_fallback(*args):
        return None

    def display_cached_preview(*args):
        pass
    ...
    if should_update_preview:
        try:
            ...
            debounce_timeout_seconds = _to_float_scalar(
                ss.get("debounce_timeout_seconds", 2.0)
            )
