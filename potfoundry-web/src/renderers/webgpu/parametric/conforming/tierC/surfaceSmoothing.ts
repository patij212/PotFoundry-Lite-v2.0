// surfaceSmoothing.ts — SRC region-layer kernel dep (ported verbatim from research/bridge/surfaceSmoothing.ts;
// the ONLY change from the research copy is the AnalyticRadiusFn import path).
//
