...
// Keep only u00b11 columns around ridge for fan triangulation.
const STITCH_BAND_HALF_WIDTH = 1;

/** v16.5: Narrower lock band within the stitch band.
 * The u00b11 neighbor quads still get chain-directed diagonals, but are
