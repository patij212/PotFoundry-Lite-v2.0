...
export const STYLE_SCHEMAS: Record<StyleName, StyleSchema> = {
  ...
  GothicArches: {
    name: 'Gothic Arches',
    description: 'Framed cathedral relief: lancet arches below, diamond lattice above.',
    params: {
      ...
      ga_counts: {
        ...
        default: 12,
        label: 'Arch Count',
        description: 'Number of pointed arches around circumference (12 recommended for best look)',
      },
      ga_relief: {
        type: 'float',
        min: 0,
      ...
      ga_diamond: {
        ...
        default: 0.55,
        label: 'Top Tracery',
        description: 'Upper tier diamond lattice intensity',
      },
      ga_x: {
        type: 'float',
        min: 0,
        ...
        default: 0.65,
        label: 'In-Arch X',
        description: 'Diagonal cross-bracing inside arch bays (lower tier)',
      },
    },
    advancedParams: {
      ga_spring: {
      ...
      ga_rib: {
        ...
        default: 0.08,
        label: 'Rib Thickness',
        description: 'Thickness of arch ribs (chunky = good for printing)',
      },
      ga_col: {
        type: 'float',
        min: 0.10,
      ...
      ga_tracery_thick: {
        ...
        step: 0.05,
        default: 0.5,
        label: 'Tracery Thickness',
        description: 'Width of top lattice lines (thicker for low-res meshes)',
      },
      ga_top_start: {
        type: 'float',
        min: 0,
        ...
        default: 0.6,
        label: 'Tracery Start',
        description: 'Control: 0=low tracery start, 1=high (mapped to 55%-85% of arch span)',
      },
      ga_recess: {
        type: 'float',
        min: 0,
        ...
        default: 0.25,
        label: 'Panel Recess',
        description: 'Depth of carved panel behind ribs (\"finished\" look)',
      },
    },
  },
  ...
  WaveInterference: {
    ...
    description: 'Organic moiré patterns from helical wave superposition.',
    params: {
      // Basic parameters (shown by default)
      wi_count: {
        type: 'float',
        ...
        default: 0.55,
        label: 'Feature Count',
        description: 'Main pattern density (0=sparse ~16 cycles, 1=dense ~90 cycles)',
      },
      wi_depth: {
        type: 'float',
        min: 0,
        ...
        default: 2.5,
        label: 'Relief Depth',
        description: 'Depth of the pattern in mm',
        unit: 'mm',
      },
      wi_line_density: {
        type: 'float',
        ...
        description: 'How many contour lines appear in the pattern',
      },
      wi_detune: {
        type: 'float',
        min: 0,
        ...
        step: 0.05,
        default: 0.25,
        label: 'Moiré Strength',
        description: 'Frequency difference between waves (creates moiré effect)',
      },
      wi_blend: {
        type: 'float',
        min: 0,
        ...
        default: 0.85,
        label: 'Pattern Style',
        description: '0=smooth waves, 1=sharp contour lines',
      },
    },
    advancedParams: {
      wi_pitch: {
        ...
        default: 0.65,
        label: 'Helix Pitch',
        description: 'Vertical frequency of the wave pattern',
      },
      wi_twist: {
        type: 'float',
        min: 0,
        ...
        step: 0.05,
        default: 0.50,
        label: 'Pitch Mismatch',
        description: 'Difference in pitch between crossing waves (0.5=centered)',
      },
      wi_warp: {
        type: 'float',
        min: 0,
        ...
        default: 0.45,
        label: 'Domain Warp',
        description: 'Amount of organic distortion applied to the pattern',
      },
      wi_warp_scale: {
        type: 'float',
        min: 0,
        ...
        default: 0.50,
        label: 'Warp Scale',
        description: 'Frequency of the domain warp distortion',
      },
      wi_contrast: {
        type: 'float',
        min: 0,
        ...
        description: 'Sharpness of ridges (0=smooth, 1=sharp)',
      },
      wi_edge_fade: {
        type: 'float',
        min: 0,
        ...
        default: 0.50,
        label: 'Edge Fade',
        description: 'How much the pattern fades near top/bottom edges',
      },
      wi_phase: {
        type: 'float',
        min: 0,
        ...
        default: 0.0,
        label: 'Phase',
        description: 'Rotates/shifts the entire pattern',
      },
    },
  },
};
