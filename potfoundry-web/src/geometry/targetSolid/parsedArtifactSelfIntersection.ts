...
export const DEFAULT_SELF_INTERSECTION_MAX_BVH_BYTES = 96 * 1024 * 1024;
export const DEFAULT_SELF_INTERSECTION_MAX_BUILD_WORK = 20_000_000;
export const DEFAULT_SELF_INTERSECTION_MAX_TRAVERSAL_VISITS = 20_000_000;
export const DEFAULT_SELF_INTERSECTION_MAX_BROAD_PHASE_PAIR_CHECKS = 20_000_000;
export const DEFAULT_SELF_INTERSECTION_MAX_CANDIDATE_PAIRS = 10_000_000;
export const DEFAULT_SELF_INTERSECTION_MAX_FOUND_PAIRS = 64;
export const DEFAULT_SELF_INTERSECTION_LEAF_SIZE = 8;
export const HARD_SELF_INTERSECTION_MAX_BVH_BYTES = 128 * 1024 * 1024;
export const HARD_SELF_INTERSECTION_MAX_BUILD_WORK = 50_000_000;
export const HARD_SELF_INTERSECTION_MAX_TRAVERSAL_VISITS = 50_000_000;
export const HARD_SELF_INTERSECTION_MAX_BROAD_PHASE_PAIR_CHECKS = 50_000_000;
export const HARD_SELF_INTERSECTION_MAX_CANDIDATE_PAIRS = 25_000_000;
export const HARD_SELF_INTERSECTION_MAX_FOUND_PAIRS = 10_000;
export const HARD_SELF_INTERSECTION_MAX_ELAPSED_MILLISECONDS = 30_000;
