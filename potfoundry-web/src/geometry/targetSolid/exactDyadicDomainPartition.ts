...
export const DEFAULT_DYADIC_PARTITION_MAX_TRIANGLES = 65_536;
export const DEFAULT_DYADIC_PARTITION_MAX_BUILD_WORK = 5_000_000;
export const DEFAULT_DYADIC_PARTITION_MAX_BVH_NODES = 131_072;
export const DEFAULT_DYADIC_PARTITION_MAX_TRAVERSAL_VISITS = 10_000_000;
export const DEFAULT_DYADIC_PARTITION_MAX_BROAD_PHASE_PAIR_CHECKS = 10_000_000;
export const DEFAULT_DYADIC_PARTITION_MAX_PAIR_CHECKS = 5_000_000;
export const DEFAULT_DYADIC_PARTITION_MAX_ELAPSED_MILLISECONDS = 15_000;
export const HARD_DYADIC_PARTITION_MAX_TRIANGLES =
  DEFAULT_DYADIC_PARTITION_MAX_TRIANGLES;
export const HARD_DYADIC_PARTITION_MAX_BUILD_WORK =
  DEFAULT_DYADIC_PARTITION_MAX_BUILD_WORK;
export const HARD_DYADIC_PARTITION_MAX_BVH_NODES =
  DEFAULT_DYADIC_PARTITION_MAX_BVH_NODES;
export const HARD_DYADIC_PARTITION_MAX_TRAVERSAL_VISITS =
  DEFAULT_DYADIC_PARTITION_MAX_TRAVERSAL_VISITS;
export const HARD_DYADIC_PARTITION_MAX_BROAD_PHASE_PAIR_CHECKS =
  DEFAULT_DYADIC_PARTITION_MAX_BROAD_PHASE_PAIR_CHECKS;
export const HARD_DYADIC_PARTITION_MAX_PAIR_CHECKS =
  DEFAULT_DYADIC_PARTITION_MAX_PAIR_CHECKS;
export const HARD_DYADIC_PARTITION_MAX_ELAPSED_MILLISECONDS = 30_000;
