...
const DEFAULT_STRUCTURAL_MAX_TOTAL_BYTES = 384 * 1024 * 1024;
const HARD_STRUCTURAL_MAX_TOTAL_BYTES = 384 * 1024 * 1024;
const DEFAULT_STRUCTURAL_MAX_TOTAL_WORK_UNITS = 75_000_000;
const HARD_STRUCTURAL_MAX_TOTAL_WORK_UNITS = 100_000_000;
const DEFAULT_STRUCTURAL_MAX_ELAPSED_MILLISECONDS = 15_000;
const HARD_STRUCTURAL_MAX_ELAPSED_MILLISECONDS = 30_000;
