...
const DEFAULT_MAX_TOTAL_PARTITION_WORK_UNITS = 20_000_000;
const HARD_MAX_TOTAL_PARTITION_WORK_UNITS = 50_000_000;
const DEFAULT_MAX_ELAPSED_MILLISECONDS = 15_000;
const HARD_MAX_ELAPSED_MILLISECONDS =
  HARD_DYADIC_PARTITION_MAX_ELAPSED_MILLISECONDS;
const HARD_MAX_TOTAL_MAPPED_TRIANGLES = 131_072;
