...
// v5b (2026-07-19): the Gyroid gentle-soft cap-point artifact (walls at the
// per-patch hard cap) totals 2,410,496; ×2 again.
const HARD_MAX_TOTAL_MAPPED_TRIANGLES = 4_194_304;
