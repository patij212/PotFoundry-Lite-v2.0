...
// MEDIUM-fine (8 offsets, planarizable at 10M): 4e-4 spacing across the steep half of the ramp where the outliers
// concentrate (the 5e-4-1e-3 span facets). The full 12-offset uniform ladder overflows planarizeMM's pair-Set at 10M
// (156k picket verts) — an instrument ceiling, not a mesh limit; the 8-offset ladder shows the frontier DIRECTION.
export const BW_FINE_LADDER_U = [0, 0.0004, 0.0008, 0.0012, 0.0016, 0.0022, 0.0028, 0.0034];
export const BW_FINE_LADDER_T = [0, 0.0008, 0.0016, 0.0024, 0.0032, 0.0044, 0.0056, 0.0068];
