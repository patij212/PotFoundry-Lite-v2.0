...
This project is indexed by GitNexus as **PotFoundry-Lite-v2.0** (49448 symbols, 88546 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
