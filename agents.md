...
This project is indexed by GitNexus as **PotFoundry-Lite-v2.0** (65034 symbols, 122254 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
