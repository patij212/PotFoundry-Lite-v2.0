...
with open(p,'r',encoding='utf-8') as f:
    for line in f:
        ...
        for r in obj.get('rows',[]):
            if isinstance(r,dict) and r.get('zi')==42 and 'R_analysis_sample' in r and 'Env_sample' in r and 'Env_to_use_sample' in r and 'origin_map_sample' in r:
                found=r
                break
        if found: break
if not found:
...
print('argmin_bridge',argmin_bridge,'mapped_bridge',mapped_bridge,'sector_index_bridge',sec_bridge)
print('argmin_analysis',argmin_analysis,'mapped_analysis',mapped_analysis,'sector_index_analysis',sec_analysis)
