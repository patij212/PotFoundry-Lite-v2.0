...
def build_pot_mesh(H: float, Rt: float, Rb: float, t_wall: float, t_bottom: float, r_drain: float,
    ...
    for i in range(rows):
        ...
        # Outward-facing winding (+radial) for export-grade normals; see
        # potfoundry.core.mesh_quality.orient_outward for the reference.
    ...
    for i in range(rows_in):
        ...
        # Inner wall normals point into the cavity (outward from the solid).
