...
class TestLoadConfig:
    ...
    def test_load_config_v2(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_data = {
                "version": 2,
                "outdir": "output",
                "recipes": [{"name": "test_pot", "style": "SuperformulaBlossom"}],
            }
    ...
    def test_load_config_v1_migration(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_data = {
                "version": 1,
                "outdir": "out",
                "recipes": [{"name": "pot1", "style": "SuperformulaBlossom"}],
            }
            config_path.write_text(yaml.dump(config_data))
    ...
    def test_load_config_no_version_defaults_to_v1(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_data = {"recipes": [{"name": "old_pot", "style": "FourierBloom"}]}
            config_path.write_text(yaml.dump(config_data))
    ...
    def test_load_config_unsupported_version(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_data = {"version": 99, "recipes": []}
            config_path.write_text(yaml.dump(config_data))
...
class TestValidateRecipe:
    ...
    def test_validate_recipe_both_style_and_use(self):
        ...
        cfg = Config()
        recipe = {"name": "test", "style": "SuperformulaBlossom", "use": "preset1"}
    ...
    def test_validate_recipe_unknown_preset(self):
        ...
        cfg = Config(presets={})
        recipe = {"name": "test", "use": "nonexistent_preset"}
    ...
    def test_validate_recipe_unknown_style(self):
        ...
        cfg = Config()
        recipe = {"name": "test", "style": "NonExistentStyle"}
...
class TestRealizeRecipe:
    ...
    def test_realize_recipe_simple(self):
        ...
        cfg = Config()
        recipe = {"name": "simple_pot", "style": "SuperformulaBlossom"}
...
class TestBuildFromYaml:
    ...
    def test_build_from_yaml_invalid_recipe(self):
        ...
        cfg = Config(recipes=[{"name": "bad", "style": "NonExistentStyle"}])
    ...
    def test_build_from_yaml_with_manifest(self):
        ...
        cfg = Config(recipes=[{"name": "test", "style": "SuperformulaBlossom"}])
    ...
    def test_build_from_yaml_configv2(self):
        ...
        config = ConfigV2(recipes=[{"name": "pydantic_pot", "style": "HarmonicRipple"}])
