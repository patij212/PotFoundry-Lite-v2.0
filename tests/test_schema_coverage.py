...
class TestRecipeModel:
    ...
    def test_recipe_rejects_neither_style_nor_use(self):
        ...
        with pytest.raises(ValidationError, match="must provide either 'style' or 'use'"):
    ...
    def test_recipe_rejects_both_style_and_use(self):
        ...
        with pytest.raises(ValidationError, match="Provide only one of 'style' or 'use'"):
            RecipeModel(name="invalid_pot", style="SuperformulaBlossom", use="my_preset")
...
class TestPresetModel:
    ...
    def test_preset_with_size(self):
        ...
        preset = PresetModel(
            style="FourierBloom",
            size={"height": 130.0, "top_od": 150.0}
        )
...
class TestConfigV2:
    ...
    def test_config_v2_rejects_wrong_version(self):
        ...
        with pytest.raises(ValidationError, match="Input should be 2"):
            ConfigV2(version=1, recipes=[{"name": "test", "style": "SuperformulaBlossom"}])
