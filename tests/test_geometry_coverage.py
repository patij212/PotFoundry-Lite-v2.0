...
class TestStyleFunctions:
    ...
    def test_spiral_ridges_custom_params(self):
        ...
        result = r_outer_spiral_ridges(
            theta=np.pi/2, z=70, r0=55, H=100, opts=opts
        )
        assert result > 0
    ...
    def test_harmonic_ripple_default(self):
        ...
        result = r_outer_harmonic_ripple(
            theta=0, z=50, r0=50, H=100, opts={}
        )
        assert result > 0
    ...
    def test_harmonic_ripple_custom_params(self):
        ...
        result = r_outer_harmonic_ripple(
            theta=np.pi/4, z=60, r0=50, H=100, opts=opts
        )
        assert result > 0
...
class TestBuildPotMeshEdgeCases:
    ...
    def test_build_pot_high_resolution(self):
        ...
        verts, faces, diag = build_pot_mesh(
            H=150, Rt=80, Rb=60, t_wall=3, t_bottom=3, r_drain=12,
            expn=1.1, n_theta=200, n_z=100,
    ...
    def test_build_pot_extreme_taper(self):
        ...
        verts, faces, diag = build_pot_mesh(
            H=120, Rt=90, Rb=30, t_wall=3, t_bottom=3, r_drain=8,
            expn=0.7, n_theta=100, n_z=60,
